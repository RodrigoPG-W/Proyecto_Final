...
void gotoxy(int x, int y);		//Permite indicar coordenadas en la pantalla
...
void Menu(){
	...
	printf("\n%c------------------%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c------------------%c",204,206,205,205,205,205,205,205,205,205,205,205,205,205,205,205,205,205,205,205,203,205,205,205,205,205,205,205,205,205,205,205,205,205,205,205,205,205,205,206,185);
	printf("\n%c A.Insertar       %c C.Modificar      %c E.Mostrar        %c G.Guardar        %c",186,186,186,186,186);
	printf("\n%c------------------%c------------------%c------------------%c------------------%c",204,206,206,206,185);
	printf("\n%c B.Buscar         %c D.Eliminar       %c F. Salir         %c H.Ayuda          %c",186,186,186,186,186);
...
void Ayuda(char menu){
	...
	if (menu=='0')
		...
		{
			printf("El programa es sensible a may%csculas y min%csculas\n\n",163,163);
